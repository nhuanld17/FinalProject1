...
public class LoginGUI extends JFrame {
	...
	public LoginGUI() {
		...
		btnNewButton.setIcon(new ImageIcon("icon\\icons8-admin-30.png"));
		...
		btnEmployeeLogin.setIcon(new ImageIcon("icon\\icons8-manager-30.png"));
		...
		lblNewLabel_3.setIcon(new ImageIcon("icon\\hotelcali1-1 (1).jpg"));
