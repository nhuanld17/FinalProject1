...
//	}
	 ...
	 */
	public EmployeeGUI() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("icon\\icons8-hotel-48.png"));
		setResizable(false);
		setTitle("ADMIN AREA");
		...
		lblNewLabel.setIcon(new ImageIcon("icon\\icons8-customer-50.png"));
		...
		btn_Them.setIcon(new ImageIcon("icon\\icons8-add-24.png"));
		...
		btn_Sua.setIcon(new ImageIcon("icon\\icons8-edit-30.png"));
		...
		btn_Xoa.setIcon(new ImageIcon("icon\\icons8-delete-24.png"));
		...
		btnNewButton.setIcon(new ImageIcon("icon\\icons8-sign-out-30.png"));
		...
		btn_find_name.setIcon(new ImageIcon("icon\\icons8-find-25.png"));
		...
		lblNewLabel_2.setIcon(new ImageIcon("icon\\icons8-bill-50.png"));
		...
		btn_Tim_cccd_1.setIcon(new ImageIcon("icon\\icons8-find-25.png"));
		...
		btn_XoaHoaDon.setIcon(new ImageIcon("icon\\icons8-delete-24.png"));
		...
		btn_Tinh.setIcon(new ImageIcon("icon\\icons8-calculator-24.png"));
		...
		btn_Chart.setIcon(new ImageIcon("icon\\icons8-chart-25.png"));
		...
		btn_Chart_1.setIcon(new ImageIcon("icon\\icons8-chart-25.png"));
		...
		btn_Chart_Revenue_Year.setIcon(new ImageIcon("icon\\icons8-chart-25.png"));
		...
		btn_Chart_Order_Year.setIcon(new ImageIcon("icon\\icons8-chart-25.png"));
